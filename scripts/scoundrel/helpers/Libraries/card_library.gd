...
static var specialDeck : Array[CardInfo]=[
	...
	#Potions
	CardInfo.CreateCardWithAbility("2ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/2ofPotions.png", 2, "+1 Max Health", PotionAbilities.TwoOfPotions),
	CardInfo.CreateCardWithAbility("3ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/3ofPotions.png", 3, "Ability Description: 3", PotionAbilities.ThreeOfPotions),
	CardInfo.CreateCardWithAbility("4ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/4ofPotions.png", 4, "Ability Description: 4", PotionAbilities.FourOfPotions),
	CardInfo.CreateCardWithAbility("5ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/5ofPotions.png", 5, "+2 to next attack.", PotionAbilities.FiveOfPotions),
	CardInfo.CreateCardWithAbility("6ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/6ofPotions.png", 6, "Completely repairs your weapon.", PotionAbilities.SixOfPotions),
	CardInfo.CreateCardWithAbility("7ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/7ofPotions.png", 7, "Flee a room for free.", PotionAbilities.SevenOfPotions),
	CardInfo.CreateCardWithAbility("8ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/8ofPotions.png", 8, "Peek at the next room.", PotionAbilities.EightOfPotions),
	CardInfo.CreateCardWithAbility("9ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/9ofPotions.png", 9, "Ability Description: 9", PotionAbilities.NineOfPotions),
	CardInfo.CreateCardWithAbility("10ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/10ofPotions.png", 10, "Ability Description: 10", PotionAbilities.TenOfPotions),
	CardInfo.CreateCardWithAbility("JackofPotions",TDCardData_Art.SuitType.Potions, "res://assets/cards/JackofPotions.png", 11, "Ability Description: Jack", PotionAbilities.JackOfPotions),
	CardInfo.CreateCardWithAbility("QueenofPotions",TDCardData_Art.SuitType.Potions, "res://assets/cards/QueenofPotions.png", 12, "Ability Description: Queen", PotionAbilities.QueenOfPotions),
	CardInfo.CreateCardWithAbility("KingofPotions",TDCardData_Art.SuitType.Potions, "res://assets/cards/KingofPotions.png", 13, "Ability Description: King", PotionAbilities.KingOfPotions),
	CardInfo.CreateCardWithAbility("AceofPotions",TDCardData_Art.SuitType.Potions, "res://assets/cards/AceofPotions.png", 14, "Doesn't do anything. It just has art right now.", PotionAbilities.AceOfPotions),
	#Ghosts
...
static var standardDeck : Array[CardInfo] = [
	...
	#Potions
	CardInfo.new("2ofPotions", TDCardData_Art.SuitType.Potions, "res://assets/cards/2ofPotions.png", 2, "+1 Max Health"),
